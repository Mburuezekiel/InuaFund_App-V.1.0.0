          ...
          Container(
            ...
            child: FadeTransition(
              ...
              child: SlideTransition(
                position: Tween(begin: const Offset(0, .07), end: Offset.zero)
                    .animate(_anim),
                child: Column(
  ...
  Widget build(BuildContext context) => SizedBox(
        ...
        child: ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            elevation: 8,
            shadowColor: _C.green.withOpacity(0.45),
          ),
          child: Text(label,
              style: const TextStyle(
                  fontFamily: 'Poppins',
...
class _StarFieldState extends State<_StarField>
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
        animation: _c,
        builder: (_, __) =>
            CustomPaint(painter: _StarPainter(_c.value), size: Size.infinite),
      );
}
...
class _StarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 48; i++) {
      ...
      final op = (0.2 + rng.nextDouble() * 0.45 + (i % 3 == 0 ? t * 0.3 : 0))
          .clamp(0.0, 1.0);
...
class _RealisticCityPainter extends CustomPainter {
  ...
  void _drawBuilding({
    ...
    switch (shape) {
      ...
      case _crown:
        canvas.drawRect(
            Rect.fromLTWH(x, top + bh * 0.55, bw, bh * 0.45), bodyPaint);
        final cw = bw * 0.5;
        final cx2 = x + (bw - cw) / 2;
        canvas.drawRRect(
    ...
    for (int c = 1; c < cols; c++) {
      canvas.drawLine(Offset(x + bw * c / cols, top + 4),
          Offset(x + bw * c / cols, groundY), panelPaint);
    }
      ...
      for (int r = 0; r < winRows; r++) {
        ...
        canvas.drawRRect(
            RRect.fromRectAndRadius(
                Rect.fromLTWH(wx, wy, ww, wh), const Radius.circular(1)),
            Paint()..color = wc);
      }
    }
    ...
    if (seed == 0) {
      for (int t = 0; t < 2; t++) {
        ...
        canvas.drawRect(Rect.fromLTWH(tx, ty, 8, 14),
            Paint()..color = facade.withOpacity(0.55));
        canvas.drawOval(
            Rect.fromCenter(center: Offset(tx + 4, ty), width: 10, height: 5),
            Paint()..color = facade.withOpacity(0.45));
      }
    } else if (seed == 1) {
      final ax = x + bw * 0.5;
      final ap = Paint()
        ..color = facade.withOpacity(0.70)
        ..strokeWidth = 1.5
      ...
      for (int a = 0; a < 3; a++) {
        canvas.drawRRect(
            RRect.fromRectAndRadius(
                Rect.fromLTWH(
                    x + bw * 0.1 + a * bw * 0.28, top - 7, bw * 0.18, 7),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final layers = isLight
        ? [
            (
              body: const Color(0xFFD4DCE8),
              facade: const Color(0xFFE8EEF5),
              winOn: const Color(0xFFFFF5D0),
              winOff: const Color(0xFFBCC8D8)
            ),
            (
              body: const Color(0xFF8FA5BE),
              facade: const Color(0xFFAABFD4),
              winOn: const Color(0xFFFFF0B0),
              winOff: const Color(0xFF6E88A0)
            ),
            (
              body: const Color(0xFF5A7A9A),
              facade: const Color(0xFF7294B2),
              winOn: const Color(0xFFFFE580),
              winOff: const Color(0xFF3F5E78)
            ),
            (
              body: const Color(0xFF2C4A62),
              facade: const Color(0xFF3D6282),
              winOn: const Color(0xFFFFD84A),
              winOff: const Color(0xFF1A3248)
            ),
          ]
        : [
            (
              body: const Color(0xFF071410),
              facade: const Color(0xFF0D2018),
              winOn: const Color(0xFFFFE070),
              winOff: const Color(0xFF040E0A)
            ),
            (
              body: const Color(0xFF0A1E14),
              facade: const Color(0xFF122A1C),
              winOn: const Color(0xFFFFCC44),
              winOff: const Color(0xFF06120D)
            ),
            (
              body: const Color(0xFF0E2A1A),
              facade: const Color(0xFF1A3D26),
              winOn: const Color(0xFFFFC03A),
              winOff: const Color(0xFF081610)
            ),
            (
              body: const Color(0xFF112E1C),
              facade: const Color(0xFF1F4A2E),
              winOn: const Color(0xFFFFB830),
              winOff: const Color(0xFF091810)
            ),
          ];
    ...
    void drawLayer(
        dynamic L, List<(double, double, double, int, int, int)> bldgs) {
    ...
    drawLayer(layers[0], [
      (0.00, 0.06, 0.22, _flat, 2, 3),
      (0.05, 0.05, 0.19, _flat, 2, 3),
      (0.09, 0.07, 0.25, _flat, 2, 4),
      (0.15, 0.04, 0.18, _flat, 2, 3),
      (0.18, 0.06, 0.22, _stepped, 2, 4),
      (0.23, 0.05, 0.20, _flat, 2, 3),
      (0.27, 0.07, 0.27, _flat, 3, 4),
      (0.33, 0.04, 0.17, _flat, 2, 3),
      (0.36, 0.06, 0.24, _flat, 2, 4),
      (0.41, 0.05, 0.21, _flat, 2, 3),
      (0.45, 0.08, 0.28, _flat, 3, 4),
      (0.52, 0.04, 0.18, _flat, 2, 3),
      (0.55, 0.06, 0.23, _flat, 2, 4),
      (0.60, 0.05, 0.20, _flat, 2, 3),
      (0.64, 0.07, 0.26, _stepped, 3, 4),
      (0.70, 0.04, 0.17, _flat, 2, 3),
      (0.73, 0.06, 0.22, _flat, 2, 3),
      (0.78, 0.05, 0.19, _flat, 2, 3),
      (0.82, 0.07, 0.25, _flat, 3, 4),
      (0.88, 0.04, 0.18, _flat, 2, 3),
      (0.91, 0.06, 0.23, _flat, 2, 4),
      (0.96, 0.04, 0.20, _flat, 2, 3)
    ]);
    drawLayer(layers[1], [
      (0.00, 0.08, 0.36, _flat, 3, 6),
      (0.07, 0.07, 0.42, _stepped, 3, 6),
      (0.13, 0.09, 0.38, _flat, 3, 5),
      (0.21, 0.06, 0.33, _pyramid, 3, 5),
      (0.26, 0.10, 0.48, _flat, 4, 7),
      (0.35, 0.07, 0.40, _chamfer, 3, 6),
      (0.41, 0.08, 0.44, _stepped, 3, 6),
      (0.48, 0.06, 0.35, _flat, 3, 5),
      (0.53, 0.10, 0.50, _flat, 4, 7),
      (0.62, 0.07, 0.39, _pyramid, 3, 6),
      (0.68, 0.08, 0.43, _flat, 3, 6),
      (0.75, 0.07, 0.37, _stepped, 3, 5),
      (0.81, 0.09, 0.46, _chamfer, 3, 6),
      (0.89, 0.06, 0.33, _flat, 3, 5),
      (0.94, 0.06, 0.38, _flat, 3, 5)
    ]);
    drawLayer(layers[2], [
      (0.00, 0.09, 0.52, _flat, 4, 8),
      (0.08, 0.08, 0.60, _stepped, 4, 9),
      (0.15, 0.11, 0.55, _chamfer, 4, 8),
      (0.25, 0.07, 0.47, _pyramid, 3, 7),
      (0.31, 0.12, 0.68, _flat, 5, 10),
      (0.42, 0.08, 0.57, _stepped, 4, 8),
      (0.49, 0.10, 0.62, _crown, 4, 9),
      (0.58, 0.07, 0.50, _flat, 3, 7),
      (0.64, 0.11, 0.65, _chamfer, 4, 9),
      (0.74, 0.08, 0.53, _stepped, 4, 8),
      (0.81, 0.10, 0.59, _flat, 4, 8),
      (0.90, 0.10, 0.54, _pyramid, 4, 8)
    ]);
    drawLayer(layers[3], [
      (0.00, 0.11, 0.70, _flat, 5, 11),
      (0.10, 0.09, 0.82, _pyramid, 4, 12),
      (0.18, 0.13, 0.74, _stepped, 5, 11),
      (0.30, 0.08, 0.65, _chamfer, 4, 10),
      (0.37, 0.15, 0.94, _crown, 6, 14),
      (0.51, 0.09, 0.72, _flat, 4, 11),
      (0.59, 0.12, 0.80, _stepped, 5, 12),
      (0.70, 0.09, 0.68, _pyramid, 4, 10),
      (0.78, 0.13, 0.88, _flat, 5, 13),
      (0.90, 0.10, 0.73, _chamfer, 4, 11)
    ]);

    canvas.drawRect(
        Rect.fromLTWH(0, h - 18, w, 18),
        Paint()
          ..color =
              isLight ? const Color(0xFF4A6275) : const Color(0xFF081510));
    canvas.drawRect(
        Rect.fromLTWH(0, h - 10, w, 10),
        Paint()
          ..color =
              isLight ? const Color(0xFF3A5A6A) : const Color(0xFF061409));
    final dashP = Paint()
  ...
  @override
  bool shouldRepaint(_RealisticCityPainter o) => o.isLight != isLight;
}
...
class _CoinsIllustration extends StatefulWidget {
  ...
  @override
  State<_CoinsIllustration> createState() => _CoinsState();
}

class _CoinsState extends State<_CoinsIllustration>
    with SingleTickerProviderStateMixin {
  late final AnimationController _c =
      AnimationController(vsync: this, duration: 3.s)..repeat(reverse: true);
  @override
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
      animation: _c,
      builder: (_, __) {
        final f = Tween(begin: -10.0, end: 10.0)
            .evaluate(CurvedAnimation(parent: _c, curve: Curves.easeInOut));
        return Stack(alignment: Alignment.center, children: [
          ...
          Transform.translate(
              offset: Offset(0, f),
              child: CustomPaint(
                  size: const Size(200, 200), painter: _CoinPainter())),
          Positioned(
              top: 20,
              right: 14,
              child: Transform.translate(
                  offset: Offset(0, f * -0.5),
                  child: const _Badge('🎯 Goal Reached!', _C.greenLight))),
          Positioned(
              bottom: 24,
              left: 10,
              child: Transform.translate(
                  offset: Offset(0, f * 0.4),
                  child: const _Badge('+KSh 5,000', _C.goldLight))),
        ]);
      });
}
...
class _CoinPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 3; i >= 0; i--) {
      ...
      canvas.drawOval(
          Rect.fromCenter(center: Offset(cx, y + 7), width: 92, height: 22),
          Paint()..color = Colors.black26);
      canvas.drawOval(
          Rect.fromCenter(center: Offset(cx, y + 4), width: 92, height: 22),
          Paint()..color = _C.gold.withOpacity(0.5));
      canvas.drawOval(
          Rect.fromCenter(center: Offset(cx, y), width: 92, height: 22),
...
class _PayIllustration extends StatefulWidget {
  ...
  @override
  State<_PayIllustration> createState() => _PayState();
}

class _PayState extends State<_PayIllustration>
    with SingleTickerProviderStateMixin {
  late final AnimationController _c =
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
      animation: _c,
      builder: (_, __) {
        final pulse = Tween(begin: 0.96, end: 1.04)
            .evaluate(CurvedAnimation(parent: _c, curve: Curves.easeInOut));
        return Stack(alignment: Alignment.center, children: [
          for (int i = 1; i <= 3; i++)
            AnimatedBuilder(
                ...
                builder: (_, __) {
                  ...
                  return Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: _C.green
                                  .withOpacity((0.5 - p * 0.5).clamp(0, 1)),
                              width: 1.2)));
                }),
          Transform.scale(
              scale: pulse,
              child: CustomPaint(
                  size: const Size(200, 215), painter: _PayPainter())),
        ]);
      });
}
...
class _PayPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _txt(canvas, 'Choose Payment', cx, cy - 61, 9, FontWeight.w700,
        Colors.white);
    const methods = [
      ('M-Pesa 🟢', _C.green),
      ('Airtel Money 🔴', Color(0xFFFF3B30)),
      ('Card 💳', Color(0xFF4A90D9))
    ];
    for (int i = 0; i < methods.length; i++) {
      final my = cy - 35 + i * 30.0;
      canvas.drawRRect(
          RRect.fromRectAndRadius(Rect.fromLTWH(cx - 40, my - 10, 80, 22),
              const Radius.circular(6)),
          Paint()..color = Colors.white.withOpacity(0.06));
      _txt(canvas, methods[i].$1, cx, my + 1, 8.5, FontWeight.w600,
...
class _CommunityIllustration extends StatefulWidget {
  ...
  @override
  State<_CommunityIllustration> createState() => _CommState();
}

class _CommState extends State<_CommunityIllustration>
    with SingleTickerProviderStateMixin {
  late final AnimationController _c =
      AnimationController(vsync: this, duration: 2.s)..repeat(reverse: true);
  @override
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
      animation: _c,
      builder: (_, __) {
        final g = Tween(begin: 0.93, end: 1.0)
            .evaluate(CurvedAnimation(parent: _c, curve: Curves.easeInOut));
        return Stack(alignment: Alignment.center, children: [
          Transform.scale(
              scale: g,
              child: CustomPaint(
                  size: const Size(220, 210), painter: _CommPainter())),
          const Positioned(
              top: 16,
              child: _Badge('🇰🇪  12,400+ Kenyans helped', _C.greenLight)),
        ]);
      });
}
...
class _CommPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final cy = size.height / 2;
    canvas.drawCircle(
        Offset(cx, cy), 82, Paint()..color = _C.green.withOpacity(0.07));
    const people = [
      (dx: -62.0, col: _C.green, sc: 0.8),
      (dx: 0.0, col: _C.goldLight, sc: 1.0),
      (dx: 62.0, col: _C.greenLight, sc: 0.8)
    ];
    for (final p in people) {
      final px = cx + p.dx;
      final s = p.sc;
      final pt = Paint()..color = p.col;
      canvas.drawCircle(Offset(px, cy - 42 * s), 15 * s, pt);
      canvas.drawRRect(
          RRect.fromRectAndRadius(
              Rect.fromCenter(
                  center: Offset(px, cy + 4 * s),
                  width: 34 * s,
                  height: 52 * s),
    ...
    canvas.drawPath(
        Path()
          ..moveTo(hx, hy + 10)
          ..cubicTo(hx, hy, hx - 13, hy - 7, hx - 13, hy + 5)
